...
urlpatterns = [
	...
	url(r'^destinations/(?P<destination_id>[0-9]+)/add_like_to_review/(?P<review_id>[0-9]+)$', views.add_like_to_review, name='add_like_to_review'),
	url(r'^destinations/(?P<destination_id>[0-9]+)/add_dislike_to_review/(?P<review_id>[0-9]+)$', views.add_dislike_to_review, name='add_dislike_to_review'),
	url(r'^destinations/(?P<destination_id>[0-9]+)/save_destination/$', views.save_destination, name='save_destination'),
	url(r'^destinations/(?P<destination_id>[0-9]+)/unsave_destination/$', views.unsave_destination, name='unsave_destination'),
